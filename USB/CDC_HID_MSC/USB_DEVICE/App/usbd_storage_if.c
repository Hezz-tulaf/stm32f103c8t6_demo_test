...
uint8_t buffer[STORAGE_BLK_SIZ] =                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
{
    ...
    0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x29, 0xE1, 0xD3, 0x15, 0x18, 0x4E, 0x4F, 0x20, 0x4E, 0x41,
 ...
 * @{
 */
//#define FLASH_START_ADDR (FLASH_BASE + (48 * 1024))
//#define FLASH_START_SIZE (16 * 1024)
//#define STORAGE_LUN_NBR 1
//#define STORAGE_BLK_SIZ 512
//#define STORAGE_BLK_NBR FLASH_START_SIZE / STORAGE_BLK_SIZ // 0x10000
...
int8_t STORAGE_Write_FS(uint8_t lun, uint8_t *buf, uint32_t blk_addr, uint16_t blk_len)
{
    ...
    //    HAL_FLASHEx_Erase(&flash_erase_handler, &PageError);
    // 页擦除，擦除后才能往这个页面写入东西
    //    for (uint16_t i = 0; i < blk_len * STORAGE_BLK_SIZ; i += 4)
    //    {
    //        HAL_FLASH_Program(FLASH_TYPEPROGRAM_WORD, FLASH_START_ADDR + blk_addr * STORAGE_BLK_SIZ + i, *(uint32_t *)(&buf[i]));
    //    }
    //    HAL_FLASH_Lock();
    char str[] = "AAA";
    if(memcmp(str,buf,3) == 0)
    {
        str[0] = 'B';
    }
    return (USBD_OK);
