...
#define STORAGE_BLK_NBR 0x16
#define STORAGE_BLK_SIZ 0x200

#define STORAGE_SIZE (STORAGE_BLK_NBR * STORAGE_BLK_SIZ) // 11KB模拟存储

static uint8_t storage_medium[STORAGE_SIZE] =                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
{
...
int8_t STORAGE_Read_FS(uint8_t lun, uint8_t *buf, uint32_t blk_addr, uint16_t blk_len)
{
    ...
    // 检查读取范围是否超出存储介质大小
    if ((start_addr + len) > STORAGE_SIZE) {
        return USBD_FAIL;
    }

	// 从模拟存储介质中复制数据到缓冲区
	memcpy(buf, storage_medium + start_addr, len);
...
int8_t STORAGE_Write_FS(uint8_t lun, uint8_t *buf, uint32_t blk_addr, uint16_t blk_len)
{
    ...
    // 将缓冲区数据写入模拟存储介质
    memcpy(storage_medium + start_addr, buf, len);
    return USBD_OK;
    /* USER CODE END 7 */
}
