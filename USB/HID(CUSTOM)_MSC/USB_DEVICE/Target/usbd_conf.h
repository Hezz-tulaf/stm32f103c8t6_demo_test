...
/*---------- -----------*/
#define USBD_MAX_NUM_INTERFACES     3  //键鼠两个接口  MSC一个接口
/*---------- -----------*/
...
/*---------- -----------*/
#define KEYBOARD_USBD_CUSTOM_HID_REPORT_DESC_SIZE     63//117//117(键鼠)//54键盘 63键盘//65(报告ID)   63//2
#define MOUSE_CUSTOM_HID_REPORT_DESC_SIZE     135//58//52
